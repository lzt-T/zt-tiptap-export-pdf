...
import { type ExportTableRow, type ExportTextBlockContent, type ExportTaskListMarker } from "./exportTypes";
...
/** 读取表格行内容。 */
function getTableRows(element: HTMLElement): ExportTableRow[] {
  // 表格行节点。
